export const IMAGES = {
  ...
  livingRooms: {
    hero: '/images/gemini/living-room-hero.png',
    wide: '/images/gemini/living-dining-wide.png',
    secondary: '/images/gemini/living-room-secondary.png',
    tvWall: '/images/gemini/living-room-tv-wall.png',
  },

  kitchens: {
    hero: '/images/gemini/kitchen-premium.png',
    secondary: '/images/gemini/kitchen-green.png',
  },

  bedrooms: {
    hero: '/images/gemini/bedroom-master.png',
    indian: '/images/gemini/bedroom-indian.png',
  },

  wardrobes: {
    hero: '/images/gemini/wardrobe-champagne.png',
  },

  homeOffice: {
    hero: '/images/gemini/home-office.png',
  },

  pooja: {
    hero: '/images/gemini/pooja-unit.png',
  },

  corporate: {
    hero: '/images/gemini/corporate-open-plan.png',
    reception: '/images/gemini/corporate-reception.png',
    workstations: '/images/gemini/corporate-workstations.png',
    conference: '/images/gemini/conference-room.png',
    breakout: '/images/gemini/breakout-lounge.png',
  },

  spas: {
    hero: '/images/gemini/spa-reception.png',
    treatmentRoom: '/images/gemini/spa-treatment-room.png',
    salonStation: '/images/gemini/salon-styling-station.png',
    waiting: '/images/gemini/spa-waiting-lounge.png',
  },
